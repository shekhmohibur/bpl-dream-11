    ...
    return (
        <div className='max-w-7xl flex justify-between items-center'>
            ...
            <div className='flex items-center gap-6'>
                <ul id='toggleMenu' className='hidden md:flex gap-7 text-gray-600'>
                ...
                <HiOutlineMenuAlt1 onClick={toggleMenu} className='cursor-pointer md:hidden'/>
                <div className='items-center rounded-lg font-semibold flex gap-3 border px-2 py-3'>
                    <span>Coin </span><img className='w-5' src={coin} alt="coin"/>
                </div>
            </div>
        </div>
    );
